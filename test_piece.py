...
class PieceTest(unittest.TestCase):
    ...
    def test_queen_get_possible_moves(self):
        ...
        positions = [(0,0), (0,7), (3,4), (7,0), (7,7)]
        expectations = {
            (0,0): [(0, 2, 'mov'), (0, 1, 'mov'), (0, 0, 'mov'), (0, 4, 'mov'), (0, 5, 'mov'), (0, 6, 'mov'), (0, 7, 'mov'), (1, 3, 'mov'), (2, 3, 'mov'), (3, 3, 'mov'), (4, 3, 'mov'), (5, 3, 'mov'), (6, 3, 'mov'), (7, 3, 'mov'), (1, 2, 'mov'), (2, 1, 'mov'), (3, 0, 'mov'), (1, 4, 'mov'), (2, 5, 'mov'), (3, 6, 'mov'), (4, 7, 'mov')],
